...
# Configurations
FILEPATH = 'xh5.0G_c.npy'
FILEPATH_origin = 'xh5.0G_s.npy'
Tx_ID = np.array([0,1,6,7])
# Noise parameters
Bias = 3
Rayleigh_factor = 3
...
def train():
    ...
    eval_callback = EvalCallback(eval_env, best_model_save_path="./data/XHProposedModel/",
                                log_path="./data/BestModels/", n_eval_episodes = 50, eval_freq = 10,
                                deterministic=True, render=False)

    model = A2C("MultiInputPolicy_new", vec_env, learning_rate=0.002, n_steps = 10,device="cpu", verbose = 1, tensorboard_log="./data/log/XH_Proposed", policy_kwargs=dict(normalize_images=False)) 
    # model = DQN("MultiInputPolicy", vec_env, learning_rate=0.002,device="cuda", verbose = 1, tensorboard_log="./data/log/SY_DQN") 
